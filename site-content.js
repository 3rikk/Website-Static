  ...
  en: {
    ...
    pages: {
      ...
      projects: {
        ...
        tiles: [
          { title: 'UpHill — A more intentional you', description: 'Work in progress. UpHill is an experimental self-development app built around direction, reflection and meaningful Pursuits rather than constant tracking, streaks or another daily checklist.', image: 'images/projects/uphill-banner.jpg', alt: 'UpHill promotional banner', href: 'https://uphill-app-landing.erik2kunz1-a27.workers.dev/#top' },
  ...
  de: {
    ...
    pages: {
      ...
      projects: {
        ...
        tiles: [
          { title: 'UpHill — A more intentional you', description: 'Work in progress. UpHill ist eine experimentelle Self-Development-App rund um Richtung, Reflexion und sinnvolle Pursuits, statt ständigem Tracking, Streaks oder einer weiteren täglichen Checkliste.', image: 'images/projects/uphill-banner.jpg', alt: 'UpHill-Werbebanner', href: 'https://uphill-app-landing.erik2kunz1-a27.workers.dev/#top' },
          { title: 'Portpass - Pass- und Visaverwaltung', description: 'Dieses Nebenprojekt von mir ist eine Open-Source-Website, die die Möglichkeiten Ihrer Reisepässe, Visa, Aufenthaltstitel und mehr in einer eleganten, modernen Benutzeroberfläche grafisch darstellt.', image: 'images/projects/portpass-banner.png', alt: 'Portpass-Banner', href: 'https://portpass.world' },
