...
const cvEntriesByLocale = {
  ...
  // INTERNSHIPS & VOLUNTEERING
  {
    ...
    description: 'I volunteered as a teacher at the English Spoken Cafés in Findikzade and Kadıköy, Istanbul, where I helped students improve their English speaking skills through interactive lessons and conversation practice.\n\nMy students were from various backgrounds and ages, and I tailored my teaching methods to meet their individual needs. I was responsible for planning interactive, intuitive and engaging lessons with a duration of two hours each on average, for group sizes ranging from 2 to 10. Finding ways to keep these mixed groups enganged and highly educational especially in evening lessons when many students were tired, posed challenges. I pursued a model where students did the majority of talking in order to strengthen their skills, while i would correct mistakes, steer topics, ask questions and teach neccessary vocabulary. While initially difficult, I was able to adapt and provide effective lessons, which taught me a range of skills regarding not only teaching english itself but also being able to work with the needs of various people and being able to hold conversations in any situation. \n\nAside from this I put a lot of effort into integrating with the local community and understanding local day to day life. This experience allowed me to significantly develop my communication and teaching skills.'
  },
  {
